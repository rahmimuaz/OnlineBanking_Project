      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h4 class="mb-0 site-logo"><a href="home.jsp" class="h2 mb-0">Web Wallet<span class="text-primary">.</span> </a></h4><!--home.jsp  -->
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="#contact-section" class="nav-link">Contact</a></li>
                 <li><a href="viewProfile.jsp" class="signup-image-link"><%=session.getAttribute("name") %></a></li><!-- get from db -->
                  <li><a href="login.jsp" class="signup-image-link">Logout</li>
 ...
 <!--biller  -->           
             <div class="slide">
                ...
                <div data-aos="fade-up" data-aos-delay="100"
                 onclick="location.href=' Transfer.jsp'" class="btn  btn-primary mr-2 mb-2">Transaction
                </div>
              </div>
<!--expense  -->
              <div class="slide">
                ...
                <p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Repudiandae minima delectus accusamus accusantium deleniti libero excepturi porro illo.</p>
                <div data-aos="fade-up" data-aos-delay="100"
                 onclick="location.href='biller.jsp'" class="btn  btn-primary mr-2 mb-2">Add Biller
                </div>
              </div>
<!--transfer  -->
              <div class="slide">
                ...
                <p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Repudiandae minima delectus accusamus accusantium deleniti libero excepturi porro illo.</p>
                <div data-aos="fade-up" data-aos-delay="100"
                 onclick="location.href='expense.jsp'" class="btn  btn-primary mr-2 mb-2">Add Expenses
                </div>
              </div>
              </div>
